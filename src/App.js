...
class App extends Component {
    ...
    playerWasSelected = (selectedPLayer, clubToDisplay) => {
        ...
        if (currentlySelected !== rank) {
            ...
            if (this.state.pickSelected != null) {
                ...
                players.clubToDisplay = clubToDisplay;
    ...
    findBPA = (pickNum) => {
        ...
        let playerToSelect = players
            ...
            .slice(10)[Math.floor(Math.random() * 10)]
        ...
        */}
        ...
        <div className='col-12'>
          <div className='row'>
            ...
            <button
              onClick={() => this.setState({ hideDrafted: !this.state.hideDrafted }) }
              style={{
                display: 'grid',
                justifyContent: 'center',
                alignItems: 'center'
              }}
              className='btn-lg btn-info col-6'  
            >
